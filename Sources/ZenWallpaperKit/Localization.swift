...
private let enStrings: [String: String] = [
    ...
    "popover.cloudFavorites": "Favorites",
    "popover.cloudFavoritesRefresh": "Refresh favorites",
    "popover.cloudFavoritesEmpty": "No favorited works match this screen",
    "popover.collectionDefault": "Favorites",
    ...
    "popover.targetDisplay": "Target display",
    "popover.setOnDisplay": "Set on display",
    "popover.setOnAllDisplays": "All displays",

    // settings
    "settings.title": "Settings",
    "settings.section.generation": "Generation",
    "settings.section.system": "System",
    "settings.section.shenma": "uyoqu.com",
    "settings.section.debug": "Debug",
    "settings.section.about": "About",
    "settings.section.display": "Display",
    "settings.imageSize": "Image Size",
    "settings.fitsScreen": "Fits main screen %@",
    "settings.multiDisplay.mode": "Multi-display mode",
    "settings.multiDisplay.unified": "Unified",
    "settings.multiDisplay.perDisplay": "Per-display",
    "settings.multiDisplay.mainOnly": "Main only",
    "settings.multiDisplay.unifiedHint": "Same wallpaper on every display.",
    "settings.multiDisplay.perDisplayHint": "Each display has its own wallpaper. Right-click a thumbnail to assign.",
    "settings.multiDisplay.mainOnlyHint": "Only the main display is touched. Others keep their system wallpaper.",
    "settings.connectedDisplays": "Connected",
    "settings.displayMain": "Main",
    "settings.displayCurrent": "Current: %@",
    "settings.displayNone": "No wallpaper set",
    ...
    "settings.privacyNote": "Cached images live at ~/Library/Application Support/ZenWallpaper/cache/. Generation runs entirely on uyoqu.com.",
    ...
    "settings.shenmaBaseUrlHelp": "Defaults to https://www.uyoqu.com. Switch to \"Local dev\" when running the qushenma frontend at http://127.0.0.1:5173.",
    ...
    "style.日系动画": "Anime Scenery",
    "style.科幻空间": "Sci-Fi Space",
...
private let zhStrings: [String: String] = [
    ...
    "popover.cloudFavorites": "云端收藏",
    "popover.cloudFavoritesRefresh": "刷新收藏列表",
    "popover.cloudFavoritesEmpty": "当前屏幕比例下暂无收藏作品",
    "popover.collectionDefault": "默认收藏",
    ...
    "popover.targetDisplay": "目标屏",
    "popover.setOnDisplay": "应用到屏幕",
    "popover.setOnAllDisplays": "所有屏幕",
    ...
    "settings.multiDisplay.mode": "多屏模式",
    "settings.multiDisplay.unified": "统一壁纸",
    "settings.multiDisplay.perDisplay": "每屏独立",
    "settings.multiDisplay.mainOnly": "仅主屏",
    "settings.multiDisplay.unifiedHint": "所有显示器使用同一张壁纸。",
    "settings.multiDisplay.perDisplayHint": "每块显示器使用独立壁纸，在缩略图上右键可分别指派。",
    "settings.multiDisplay.mainOnlyHint": "只设置主屏，其他显示器保留系统壁纸。",
    "settings.connectedDisplays": "已连接",
    "settings.displayMain": "主屏",
    "settings.displayCurrent": "当前：%@",
    "settings.displayNone": "未设置",
    ...
    "settings.privacyNote": "缓存目录：~/Library/Application Support/ZenWallpaper/cache/。生图全部在 uyoqu.com 上完成。",
    ...
    "settings.shenmaBaseUrlHelp": "默认走 https://www.uyoqu.com。本地调试时切到「本地调试」会用 http://127.0.0.1:5173。",
